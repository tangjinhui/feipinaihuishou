...
var html ={
    test:{
        ...
        PublicFrom: 'http://public.ecgci.com',
        PublicTo: 'http://public.ecgci.com',
        AccountFrom: 'http://account.ecgci.com',
        AccountTo: 'http://account.ecgci.com'
    },
    prod:{
        PcFrom: 'http://pfdev.ecgci.com',
        ...
        PublicFrom: 'http://public.ecgci.com',
        PublicTo: 'http://public.chinagoldcoin.net',
        AccountFrom: 'http://account.ecgci.com',
        AccountTo: 'http://account.chinagoldcoin.net'
    }
}
...
gulp.task('build-css', function () {
    ...
    if(conf == 'dev'){
        ...
        return gulp.src('./css/*.css')
            ...
            .pipe(replace(html[conf].PublicFrom, html[conf].PublicTo))
            .pipe(replace(html[conf].AccountFrom, html[conf].AccountTo))
            .pipe(minifyCss({compatibility:'ie7'}))
            .pipe(rev())
            .pipe(gulp.dest('dist/css'))
            .pipe(rev.manifest())
