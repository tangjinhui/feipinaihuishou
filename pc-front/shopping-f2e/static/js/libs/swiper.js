...
var Swiper = function (selector, params) {
    ...
    var defaults = {
        ...
        paginationMouseoverControl : false,   //mouseover event  by:liujianhua
    ...
    _this.destroy = function (removeStyles) {
        ...
        //mouseover event  by:liujianhua
        if(params.paginationMouseoverControl){
            removePaginationMouseOverEvents();
        }
    ...
    _this.createPagination = function (firstInit) {
        ...
        //mouseover event  by:liujianhua
        if (params.paginationMouseoverControl && _this.paginationButtons) {
            removePaginationMouseOverEvents();
        }
    ...
    //mouseover event  by:liujianhua
    function removePaginationMouseOverEvents() {
        var pagers = _this.paginationButtons;
        if (pagers) {
            for (var i = 0; i < pagers.length; i++) {
                _this.h.removeEventListener(pagers[i], 'mousemove', paginationClick);
            }
        }
    }
    function addPaginationMouseOverEvents() {
        var pagers = _this.paginationButtons;
        if (pagers) {
            for (var i = 0; i < pagers.length; i++) {
