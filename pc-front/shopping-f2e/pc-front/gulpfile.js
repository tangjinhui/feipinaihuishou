...
gulp.task('build-css', function () {
    ...
    if(conf == 'dev'){
        return gulp.src(['./css/**/*.css', '!./css/plugin/*.css'])
...
gulp.task('build-amd', function () {
    if(conf == 'dev'){
        return gulp.src(['./script/**/*.js', '!./script/libs/*.js', '!./script/modules/*.js'])
...
gulp.task('build-swf', function(){
    return gulp.src('./plupload/*')
        .pipe(gulp.dest('./dist/plupload/'))
});
...
gulp.task('build-all', function(){
    runSequence(['build-css', 'build-amd', 'build-images', 'build-libs', 'build-swf'], 'build-rev');
});
